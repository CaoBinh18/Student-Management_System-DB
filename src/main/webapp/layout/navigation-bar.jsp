            ...
            <div class="left-sidebar-scroll">
                <div class="left-sidebar-content">
                    <ul class="sidebar-elements">
                        ...
                        <li class="active"><a href="/student"><i class="icon mdi mdi-home"></i><span>List Student</span></a>
                        </li>
                        <li><a href="/score"><i class="icon mdi mdi-face"></i><span>Score Student</span></a>
                        </li>

<%--                        <li><a href="student?action=edit"><i class="icon mdi mdi-chart-donut"></i><span>Update Student</span></a>--%>
<%--                        </li>--%>
